 ...
 *********************************************************************/
	...
	Signature.prototype = {
		create: function(option) {
			...
			+ '<img title="清空画板" src="'+options.clearImgSrc+'" class="toolbtn signToolClear" />'
			+ '<img title="撤消一次" src="'+options.backImgSrc+'" class="toolbtn signToolBack" />'
			...
			+ '</style>' 
			+ '<img title="播放动画" src="'+options.okImgSrc+'" class="toolbtn signToolOk" />'
			+ '</div>'
			+ '</div>'
		...
		render: function(option) {
			if (!option.keepCanvas && this.canvas) {
